...
**Save plans to:** `claude_documents/plan_YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `claude_documents/plan_<filename>.md`. Ready to execute inline using the executing-plans skill, or I can walk through tasks one at a time. Which approach?"**
